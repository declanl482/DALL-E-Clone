    ...
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w-[600px]">
          Explore a collection of imaginative and visually stunning 
          images generated by Open AI's DALL-E model.
        </p>
      </div>

      <div className="mt-16">
        <FormField
          labelName="Search through community photos by keyword:"
          type="text"
          name="text"
      ...
      <div className="mt-10">
        {loading ? (
          ...
          <>
            ...
            xs:grid-cols-2 grids-col-1 gap-3">
              {searchedResults ? (
                <RenderCards
