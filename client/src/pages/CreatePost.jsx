  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        console.log(base64Image); // Check the logged value in the console
    ...
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w-[600px]">
          Create imaginative and visually stunning images using Open AI's DALL-E model 
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#666e75] text-[14px]">
            Once you have created the image you want, you may share it with others in the community!
          </p>
          <button
            type="submit"
            className="mt-3 text-white bg-[#6469ff] font-medium round-md text-sm w-full 
            sm:w-auto px-5 py-2.5 text-center"
          >
